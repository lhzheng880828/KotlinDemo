...
package com.android.samples.kotlin.basic.observability.ui

import androidx.lifecycle.ViewModel
import com.android.samples.kotlin.basic.observability.persistence.User
...
class UserViewModel(private val dataSource: UserDao) : ViewModel() {
    ...
    fun deleteUsers(): Completable {
        return Completable.fromAction { dataSource.deleteAllUsers() }
    }
