 ...
 *Date:19-3-7
 */
class Lesson10_ObjExpression {

    companion object {
        @Volatile private var INSTANCE: Lesson10_ObjExpression? = null

        fun getInstance(): Lesson10_ObjExpression =
                INSTANCE ?: synchronized(this){
                    INSTANCE
                            ?: Lesson10_ObjExpression().also { INSTANCE = it }
                }
    }
    ...
    */
    ...
    那么该函数或属性的实际类型 会是匿名对象声明的超类型，如果你没有声明任何超类型，就会是 Any。在匿名对象中添加的成员将无法访问。
    */
    ...
    */
    ...
    /*
    当然你也可以定义一个变量来获取获取这个对象，当时当你定义两个不同的变量来获取这个对象时，你会发现你并不能得到两个不同的
    变量。也就是说通过这种方式，我们获得一个单例。
    */
    ...
    */
    ...
    fun testObjIntroduce(args: Array<String>) {
        var s1 =  Site
        var s2 = Site
